...
class AiService {
  ...
  async generateVulnerabilitySummary(vulnerabilities: Vulnerability[]): Promise<string> {
  ...
  async generateInlineResponse(prompt: string, context: string, selectedText: string): Promise<string> {
